...
import Connect4Token from '../Connect4Token';

import { CONNECT4_STATUS_RUNNING } from '../../utils/settings';

// styles
import './Connect4Board.css';

const Connect4Board = ({ board, onColSelected, status }) => {
  return (
...
export default React.memo(Connect4Board);
